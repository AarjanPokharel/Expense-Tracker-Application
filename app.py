...
from graphs import chart, baseGraph, baseGraph2, savingGraph, savingGraph2
...
def dashboard():
    ...
    #     session['date'] = transForm.date.data
    #     return redirect(date)
    # return render_template('dashboard.html', form=transForm)
